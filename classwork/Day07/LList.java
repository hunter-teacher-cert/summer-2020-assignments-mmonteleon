...
public class LList
{
  ...
  {
    //Exception if the data passed is null
    if(data == null)
  ...
  {
    //node does not exist at that index
    ...
    // ****THIS WILL NOT BE REACHED DUE TO EXCEPTION****
  ...
  {
    //node does not exist at index (or one beyond it)
    if(index > this.length())
      throw new IndexOutOfBoundsException();
